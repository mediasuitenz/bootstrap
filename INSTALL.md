...
- Installs
    ...
    - xcode command line tools
        # If this command gives you an error regarding not being available via software
        # update then you can also download it by launching Xcode -> Xcode menu ->
        # Open Developer Tools... This will take you to an Apple dev tools site.
